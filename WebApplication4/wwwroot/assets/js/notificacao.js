...
addLoadEvent(async function () {
    ...
    //}
    //try {
    //    const rawResponse = await fetch('https://moviehuntersapi.azurewebsites.net/Amizade/GetById', myHeaders);
    //    const content = await rawResponse.json();
    //    if (content != null) {
           
    //         for (let i = 0; i < content.lenght; i++) {
            //    let notific_actual = notification_example;
            //    notific_actual = notific_actual.replace("nomeDoUsuario", content[i].nm_user);
